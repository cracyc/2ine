...
OS2EXPORT APIRET16 OS2API16 Dos16SetMaxFH(USHORT cFH) OS2APIINFO(85);
OS2EXPORT APIRET16 OS2API16 Dos16CreateCSAlias(SEL ds, PSEL pcs) OS2APIINFO(43);
...
OS2EXPORTCONSTANT OS2API OS2APIINFO(val=3,name=DosHugeShift,ord=135);
