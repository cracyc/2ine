...
static int init16_kbdcalls(void) {
    LX_NATIVE_MODULE_INIT_16BIT_SUPPORT()
        LX_NATIVE_INIT_16BIT_BRIDGE(KbdCharIn, 8, 0)
        LX_NATIVE_INIT_16BIT_BRIDGE(KbdStringIn, 12, 0)
        LX_NATIVE_INIT_16BIT_BRIDGE(KbdGetStatus, 6, 0)
        LX_NATIVE_INIT_16BIT_BRIDGE(KbdSetStatus, 6, 0)
