...
static APIRET16 bridge16to32_Dos16ResumeThread(uint8 *args) {
    LX_NATIVE_MODULE_16BIT_BRIDGE_ARG(USHORT, tid);
    return Dos16ResumeThread(tid);
}

static APIRET16 bridge16to32_Dos16SuspendThread(uint8 *args) {
    LX_NATIVE_MODULE_16BIT_BRIDGE_ARG(USHORT, tid);
    return Dos16SuspendThread(tid);
}

static APIRET16 bridge16to32_Dos16Sleep(uint8 *args) {
    LX_NATIVE_MODULE_16BIT_BRIDGE_ARG(ULONG, msec);
...
static APIRET16 bridge16to32_Dos16AllocHuge(uint8 *args) {
    LX_NATIVE_MODULE_16BIT_BRIDGE_ARG(USHORT, flags);
    LX_NATIVE_MODULE_16BIT_BRIDGE_ARG(USHORT, maxseg);
    LX_NATIVE_MODULE_16BIT_BRIDGE_PTRARG(PSEL, sel);
    LX_NATIVE_MODULE_16BIT_BRIDGE_ARG(USHORT, size);
    LX_NATIVE_MODULE_16BIT_BRIDGE_ARG(USHORT, numseg);
    return Dos16AllocHuge(numseg, size, sel, maxseg, flags);
}
...
static APIRET16 bridge16to32_Dos16QFileInfo(uint8 *args) {
    LX_NATIVE_MODULE_16BIT_BRIDGE_ARG(USHORT, cbInfoBuf);
    LX_NATIVE_MODULE_16BIT_BRIDGE_PTRARG(PVOID, pInfo);
    LX_NATIVE_MODULE_16BIT_BRIDGE_ARG(USHORT, ulInfoLevel);
    LX_NATIVE_MODULE_16BIT_BRIDGE_ARG(USHORT, hf);
    return Dos16QFileInfo(hf, ulInfoLevel, pInfo, cbInfoBuf);
}
...
static APIRET16 bridge16to32_Dos16CreateThread(uint8 *args) {
    LX_NATIVE_MODULE_16BIT_BRIDGE_ARG(ULONG, pstack);
    LX_NATIVE_MODULE_16BIT_BRIDGE_PTRARG(PUSHORT, ptid);
    LX_NATIVE_MODULE_16BIT_BRIDGE_ARG(ULONG, pfn);
    return Dos16CreateThread(pfn, ptid, pstack);
}

static APIRET16 bridge16to32_Dos16SearchPath(uint8 *args) {
    LX_NATIVE_MODULE_16BIT_BRIDGE_ARG(USHORT, cbBuf);
    LX_NATIVE_MODULE_16BIT_BRIDGE_PTRARG(PBYTE, pBuf);
    LX_NATIVE_MODULE_16BIT_BRIDGE_PTRARG(PSZ, pszFilename);
    LX_NATIVE_MODULE_16BIT_BRIDGE_PTRARG(PSZ, pszPathOrName);
    LX_NATIVE_MODULE_16BIT_BRIDGE_ARG(USHORT, flag);
    return Dos16SearchPath(flag, pszPathOrName, pszFilename, pBuf, cbBuf);
}
...
LX_NATIVE_MODULE_16BIT_SUPPORT()
    ...
    LX_NATIVE_MODULE_16BIT_API(Dos16QFileInfo)
    ...
    LX_NATIVE_MODULE_16BIT_API(Dos16CreateThread)
    LX_NATIVE_MODULE_16BIT_API(Dos16SearchPath)
...
static int init16_doscalls(void) {
    LX_NATIVE_MODULE_INIT_16BIT_SUPPORT()
        ...
        LX_NATIVE_INIT_16BIT_BRIDGE(Dos16AllocHuge, 12, 0)
        ...
        LX_NATIVE_INIT_16BIT_BRIDGE(Dos16Delete, 8, 0)
        LX_NATIVE_INIT_16BIT_BRIDGE(Dos16DupHandle, 6, 0)
        LX_NATIVE_INIT_16BIT_BRIDGE(Dos16FindClose, 2, 0)
        LX_NATIVE_INIT_16BIT_BRIDGE(Dos16FindFirst, 24, 0)
        LX_NATIVE_INIT_16BIT_BRIDGE(Dos16FindNext, 12, 0)
        LX_NATIVE_INIT_16BIT_BRIDGE(Dos16Open, 26, 0)
        LX_NATIVE_INIT_16BIT_BRIDGE(Dos16QCurDir, 10, 0)
        LX_NATIVE_INIT_16BIT_BRIDGE(Dos16QCurDisk, 8, 0)
        LX_NATIVE_INIT_16BIT_BRIDGE(Dos16QFileInfo, 10, 0)
        ...
        LX_NATIVE_INIT_16BIT_BRIDGE(Dos16Write, 12, 0)
        LX_NATIVE_INIT_16BIT_BRIDGE(DosSemRequest, 8, 0)
        LX_NATIVE_INIT_16BIT_BRIDGE(DosSemClear, 4, 0)
        LX_NATIVE_INIT_16BIT_BRIDGE(DosSemWait, 8, 0)
        LX_NATIVE_INIT_16BIT_BRIDGE(DosSemSet, 4, 0)
        LX_NATIVE_INIT_16BIT_BRIDGE(Dos16ExecPgm, 24, 0)
        LX_NATIVE_INIT_16BIT_BRIDGE(Dos16CreateThread, 12, 0)
        LX_NATIVE_INIT_16BIT_BRIDGE(Dos16SearchPath, 16, 0)
...
LX_NATIVE_MODULE_INIT({ if (!init16_doscalls()) return 0; })
    ...
    LX_NATIVE_EXPORT16(Dos16QFileInfo, 74),
    ...
    LX_NATIVE_EXPORT(DosSearchPath, 228),
